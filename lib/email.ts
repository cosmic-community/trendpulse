...
// Changed: Added new function for contact form emails
                    ...
                    <table role="presentation" style="width: 600px; max-width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                      ...
                      <tr>
                        <td style="padding: 30px;">
                          <p style="margin: 0 0 20px 0; color: #374151; font-size: 16px; line-height: 1.6;">
                            You've received a new message from the TrendPulse Daily contact form.
                          </p>
...
${message}
                          ...
                          <table role="presentation" style="width: 100%; margin: 30px 0 0 0;">
                            <tr>
                              <td align="center">
                                <a href="mailto:${email}?subject=Re: Your message to TrendPulse Daily" style="display: inline-block; background-color: #3b82f6; color: #ffffff; padding: 12px 28px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">
                                  Reply to ${name}
                                </a>
                              </td>
                            </tr>
                      ...
                      <tr>
                        <td style="background-color: #f9fafb; padding: 20px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                          <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                            Received at: ${new Date().toLocaleString()} • TrendPulse Daily Contact Form
                          </p>
                        </td>
                      </tr>
                    </table>
