...
export default function CosmicBadge({ bucketSlug }: { bucketSlug: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 flex items-center gap-2 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border text-gray-900 dark:text-gray-100 text-sm font-medium no-underline transition-colors duration-200 z-50 px-4 py-3 rounded-lg shadow-lg hover:bg-gray-50 dark:hover:bg-gray-800"
      style={{
        position: 'fixed',
        width: '180px'
      }}
